...
namespace TMSDeloitte.DAL
{
    public class HANA_DAL
    {
        ...
        public DataTable GetDataTableByQuery(string Query, string docType = "")
        {
            ...
            HanaConnection con = new HanaConnection(connectionString);
            HanaDataAdapter adpt = new HanaDataAdapter(Query, con);
            if (docType != "")
        ...
        public DataTable GetDataTableByStoredProcedure(string spName, string docType = "")
        {
            ...
            try
            {
                ...
                loCommand = Hana_DataContext.OpenConnection(connectionString, docType);
                loCommand = Hana_DataContext.SetStoredProcedure(loCommand, schemaName, spName);
                loCommand.CommandTimeout = 8;
               
                dt = Hana_DataContext.GetDateTable(loCommand, docType);
        ...
        public DataTable GetDataTableByStoredProcedureSAPB1(string spName, string docType = "")
        {
            ...
            try
            {
                ...
                loCommand = Hana_DataContext.OpenConnection(connectionString, docType);
                loCommand = Hana_DataContext.SetStoredProcedure(loCommand, SchemaNameSAPB1, spName);
                loCommand.CommandTimeout = 8;
        ...
        public DataSet GetDataSetByStoredProcedure(string spName, List<B1SP_Parameter> parameterList, string docType = "")
        {
            ...
            try
            {
                ...
                dt = Hana_DataContext.GetDateSet(loCommand, docType);
