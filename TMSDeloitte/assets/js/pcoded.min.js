            ...
            ($(".pc-navbar > li:not(.pc-caption)").on("click", function () {
                $(this).children(".pc-submenu").removeAttr("style"),
                    $(this).hasClass("pc-trigger")
                        ? ($(this).removeClass("pc-trigger"), $(this).children(".pc-submenu").slideUp(250))
                        : ($("li.pc-trigger").children(".pc-submenu").slideUp(250), $("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger"), $(this).children(".pc-submenu").slideDown(250));
            }),
            $(".pc-navbar > li:not(.pc-caption) li").on("click", function (e) {
                e.stopPropagation(),
                    $(this).hasClass("pc-trigger")
                        ? ($(this).removeClass("pc-trigger"), $(this).children(".pc-submenu").slideUp(250))
                        : ($(this).parent(".pc-submenu").find("li.pc-trigger").children(".pc-submenu").slideUp(250),
                          $(this).parent(".pc-submenu").find("li.pc-trigger").removeClass("pc-trigger"),
                          $(this).addClass("pc-trigger"),
                          $(this).children(".pc-submenu").slideDown(250));
            }));
}
function rmdrp() {
...
$(document).ready(function () {
    ...
    $(".tab-sidemenu>li").on("click", function () {
        ...
        $(".navbar-content .pc-tabcontent").removeClass("active"), $(".tab-sidemenu > li").removeClass("active"), $(this).addClass("active"), $('.navbar-content .pc-tabcontent[data-value="' + e + '"]').addClass("active");
    });